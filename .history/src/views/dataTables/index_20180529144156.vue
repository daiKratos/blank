  ...
  methods: {
    handleStatement() {
      ...
      if (this.$refs.tableView.tableName.length === 2) {
        ...
        a = `select ${this.$refs.tabView.selectConditions} from ${this.$refs.tabView.tableName[0]}  on productField.shopRawId=shopField.shopRawId  where ${this.whereConditions} limit 2,20`
      }
      console.log(a)
    }
  },
