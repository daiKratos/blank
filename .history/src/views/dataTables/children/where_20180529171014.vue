          ...
          Row
            Col(span='7')
              Select(style="width:300px", @on-change='handleCriterias')
                ...
                Option(v-if="selectedTabName.length > 1", v-for="(radioItem,radioIndex) in test", :value='`${radioItem.column_name}`', :key='radioIndex') {{radioItem.column_name}}
  ...
  data() {
    return {
      test: [
        ...
        {
          column_name: 'deliveryChargeMode',
          colum_type: 'String'
        },
        {
          column_name: 'deliveryDesc',
          colum_type: 'String'
        },
        {
          column_name: 'deliveryFee',
          colum_type: 'Double'
        },
        {
          column_name: 'deliveryLimitation',
          colum_type: 'Int'
        },
        {
          column_name: 'deliveryTime',
          colum_type: 'String'
        },
        {
          column_name: 'deliveryType',
          colum_type: 'String'
        },
        {
          column_name: 'goodCommentRate',
          colum_type: 'Float'
        },
        {
          column_name: 'isBrandShop',
          colum_type: 'Boolean'
        },
        {
          column_name: 'isNewShop',
          colum_type: 'Boolean'
        },
        {
        ...
        {
          column_name: 'productScore',
          colum_type: 'Float'
        },
        {
          column_name: 'rateCount',
          colum_type: 'Int'
        },
        {
          column_name: 'salesVolume',
          colum_type: 'Int'
        },
        {
          column_name: 'serviceScore',
          colum_type: 'Float'
        },
        {
          column_name: 'shopNameDetail',
          colum_type: 'String'
        },
        {
          column_name: 'shopRawId',
          colum_type: 'String'
        },
        {
          column_name: 'shopScore',
          colum_type: 'Float'
        },
        {
          column_name: 'startPrice',
          colum_type: 'Double'
        },
        {
          column_name: 'status',
