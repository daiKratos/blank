          ...
          Row
            Col(span='7')
              Select(style="width:300px", @on-change='handleCriterias')
                ...
                //- Option(v-else, v-for="(radioItem,radioIndex) in test", :value='radioItem.column_name', :key='radioIndex') {{radioItem.column_name}}
                Option(v-for="itemTest,testindex in test", :value="`${item.column_name}`", :key="itemTest.column_name") {{ itemTest.column_name }}
