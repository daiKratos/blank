...
export default {
  ...
  mounted() {
    ...
    const a=select product.commentCount,product.goodCommentRate,product.monthSale from product where product.commentCount>32 and product.isAvailable=false and product.productName!='34' limit 2,20
  }
}
</script>
