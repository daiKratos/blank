  ...
  methods: {
    ...
    handleStatement() {
      ...
      if (this.$refs.tabView.tableName.length === 2) {
        a = `select ${this.$refs.tabView.selectConditions} from product product join shop shopField on productField.shopRawId=shopField.shopRawId  where ${this.whereConditions} limit 2,20`
      } else {
