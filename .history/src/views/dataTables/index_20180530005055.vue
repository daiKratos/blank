<template lang="pug">
  .home-con
    ...
    .btn-con
      Button(type='primary', @click='handleStatement', :disable='btnDisable') 查看
      Button(type='info', @click='handleCommit', :disable='btnDisable') 提交
    Card.show-con
      p(slot='title')
...
export default {
  ...
  methods: {
    ...
    handleDealwith(page = 0) {
      if (this.$refs.tabView.selectConditions !== '') this.btnDisable = false
