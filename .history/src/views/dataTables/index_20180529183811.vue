  ...
  methods: {
    ...
    handleStatement() {
      ...
      if (this.$refs.tabView.tableName.length === 2) {
        a = `select ${this.$refs.tabView.selectConditions} from productField productField join shopField shopField on productField.shopRawId=shopField.shopRawId  where ${this.whereConditions} limit 2,20`
      } else {
